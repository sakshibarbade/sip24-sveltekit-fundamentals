...
<header class="bg-white py-4 shadows-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xt font-bold font-['Comic_Sans_MS']">Craftlab</h1>
...
<span class="text-grey-700">{post.content}</span>
</div>
</div>
{/each}
</div>
